...
// Blog end
 ...
 let elements = document.querySelectorAll('.panel.active > a');
$(".panel.active").each((i, elem) => {
        data.push({
            link: $(elem).find('.issue.box').attr('href')
        });
    });

let result = document.querySelector('.content').style.height;